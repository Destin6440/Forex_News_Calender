...
def build_parser() -> argparse.ArgumentParser:
    ...
    backfill_browser = backfill.add_mutually_exclusive_group()
    backfill_browser.add_argument("--interactive-browser", action="store_true", help="Show Selenium Chrome and wait for manual verification when required")
    backfill_browser.add_argument("--browser-handoff", action="store_true", help="Open ordinary Chrome, wait for visible calendar rows, then attach and continue")
    ...
    sync_browser = sync.add_mutually_exclusive_group()
    sync_browser.add_argument("--interactive-browser", action="store_true", help="Show Selenium Chrome and wait for manual verification when required")
    sync_browser.add_argument("--browser-handoff", action="store_true", help="Open ordinary Chrome, wait for visible calendar rows, then attach and continue")
