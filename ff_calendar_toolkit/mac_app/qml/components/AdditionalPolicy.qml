    ...
    ColumnLayout { id:layout;anchors.fill:parent;anchors.margins:DesignTokens.section;spacing:DesignTokens.spaceLarge
        ...
        GridLayout{columns:3;Layout.fillWidth:true;columnSpacing:DesignTokens.spaceLarge
            ...
            ColumnLayout {
                ...
                Label { text: "Minimum events"; color: DesignTokens.secondaryText; font.pixelSize: 12 }
                TextField {
                    id: minimumField
                    objectName: "minimumEventsField"
                    text: String(controller.minimumEvents)
                    validator: IntValidator { bottom: 0 }
                    Accessible.name: "Minimum total events"
            ...
            ColumnLayout {
                spacing: DesignTokens.spaceSmall
                Label { text: "Maximum events"; color: DesignTokens.secondaryText; font.pixelSize: 12 }
                TextField {
                    id: maximumField
                    objectName: "maximumEventsField"
                    text: controller.maximumEvents < 0 ? "" : String(controller.maximumEvents)
                    placeholderText: "No maximum"
                    validator: IntValidator { bottom: 0 }
                    Accessible.name: "Maximum total events"
                    Layout.fillWidth: true
